...
SSD_PRESETS = {
    ...
    'vgg512': SSDPreset(name = 'vgg512',
                        ...
                        # maps = [
                        #     SSDMap(Size(128, 128), 0.03, [2,  0.5]),
                        #     SSDMap(Size(64, 64), 0.03, [2,  0.5]),
                        #     SSDMap(Size(32, 32), 0.04, [2, 3,  0.5, 1./3.]),
                        #     SSDMap(Size(16, 16), 0.05,  [2, 3,  0.5, 1./3.]),
                        #     SSDMap(Size( 8,  8), 0.06, [2, 3,  0.5, 1./3.]),
                        #     SSDMap(Size( 4,  4), 0.07,  [2, 3,  0.5, 1./3.]),
                        #     SSDMap(Size( 2,  2), 0.08, [2, 0.5])
                        #     # SSDMap(Size( 1,  1), 0.1,  [2, 0.5])
                        # ],
                        maps = [
                            SSDMap(Size(128, 128), 0.031, [2, 1/3]),
                            SSDMap(Size(64, 64), 0.032, [2, 1/3]),
                            SSDMap(Size(32, 32), 0.04, [2,  3, 0.5, 1/3]),
                            SSDMap(Size(16, 16), 0.05, [2,  3, 0.5, 1/3 ])
                            # SSDMap(Size( 1,  1), 0.1,  [2, 0.5])
                        ],
...
#-------------------------------------------------------------------------------
def decode_boxes(pred, anchors, confidence_threshold = 0.05, lid2name = {},
                 detections_cap=200):
    """
