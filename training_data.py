...
class TrainingData:
    ...
    def __batch_generator(self, sample_list_,transforms):
        ...
        def gen_batch(batch_size, num_workers=0):
            ...
            #     #                            self.num_classes+5),
            #     #                           dtype=np.float32)
            #     label_template = np.zeros((batch_size, 89600, self.num_classes+5), dtype=np.float32)
