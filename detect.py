...
def main():
    ...
    parser.add_argument('--model', default='model.pb',
                        help='model file')
    parser.add_argument('--training-data', default='/home/moktari/SSDIR/pascal-voc/training-data.pkl',
                        help='training data')
    ...
    #---------------------------------------------------------------------------
    #./ detect.py / home / nyma / Desktop / ssd / pascal - voc / test / VOCdevkit / VOC2007 / JPEGImages / 000004.jpg
    ...
    with tf.Session() as sess:
        ...
        for i in tqdm(range(0, len(files), args.batch_size)):
            ...
            for i in range(len(batch_names)):
                boxes = decode_boxes(enc_boxes[i], anchors, 0.4, lid2name, None)
