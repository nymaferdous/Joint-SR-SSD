...
def Vgg19_simple_api(rgb, reuse):
    ...
    with tf.variable_scope("VGG19", reuse=reuse) as vs:
        ...
        print("Calculating vgg loss")
        return network, conv


def SRGAN_g_custom(t_image, is_train=False, reuse=False, insize=128):
    """ Generator in Photo-Realistic Single Image Super-Resolution Using a Generative Adversarial Network
     feature maps (n) and stride (s) feature maps (n) and stride (s)
    """
    ...
    with tf.variable_scope("SRGAN_g", reuse=reuse) as vs:
        ...
        out_1 = Conv2d(n, 3, (1, 1), (1, 1), act=tf.nn.tanh, padding='SAME', W_init=w_init, name='out1')
        print(out_1, '256_image')
        ...
        out_2 = Conv2d(n, 3, (1, 1), (1, 1), act=tf.nn.tanh, padding='SAME', W_init=w_init, name='out2')
        print(out_2, '512_image Shape')
        return out_1, out_2
