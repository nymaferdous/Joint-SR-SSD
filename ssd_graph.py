...
class SSDGRAPH:
    ...
    def __build_norms(self):
            ...
            x = l2_normalization(self.vgg_conv3_3, 20, 256, 'l2_norm_conv3_3')
            self.norm_conv3_3 = x
    ...
    def build_optimizer(self):
        ...
        # Build the optimizer
        #-----------------------------------------------------------------------
        with tf.variable_scope('optimizer_ssd'):
            ...
            for var in tf.trainable_variables():
                ...
                # var_name= var
                print("SSD Variable Name",var_name)
                ...
                if var_name_mess[0] in ['conv1_1', 'conv1_2', 'conv2_1', 'conv2_2', 'conv3_1', 'conv3_2', 'conv3_3',
                                        ...
                                        'mod_conv7','ssd_conv8_1', 'ssd_conv8_2', 'ssd_conv9_1', 'ssd_conv9_2', 'ssd_conv10_1',
                                        'ssd_conv10_2', 'ssd_conv_11_1', 'ssd_conv_11_2']:
                    detector_vars.append(var)

            detector_vars = detector_vars
            print("Detector Variable", detector_vars)

            with tf.variable_scope('learning_rate'):
                lr_v = tf.Variable(1e-4, trainable=False)

            optimizer = tf.train.AdamOptimizer(lr_v).minimize(self.loss, var_list=detector_vars)
