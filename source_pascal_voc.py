...
#-------------------------------------------------------------------------------
label_defs = [
    # Label('plane',       rgb2bgr((0,    0,   0))),
    # Label('van',         rgb2bgr((81,   0,  81))),
    # Label('boat',        rgb2bgr((128,  64, 128))),
    # Label('campingcar',  rgb2bgr((244,  35, 232))),
    # Label('bus',         rgb2bgr((230, 150, 140))),
    Label('vehicle',         rgb2bgr(( 44,  101,  217)))
    ...
    # Label('motorcycle',  rgb2bgr((107, 142,  35))),
    # Label('person',      rgb2bgr(( 52, 151,  52))),
    # Label('tractor',     rgb2bgr(( 70, 130, 180))),
    # Label('sheep',       rgb2bgr((220,  20,  60))),
    # Label('pickup',      rgb2bgr((  0,   0, 142))),
    # Label('truck',       rgb2bgr((  0,   0, 230))),
    # Label('other',       rgb2bgr((119,  11,  32)))
    ]
