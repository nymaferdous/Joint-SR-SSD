...
parser.add_argument('--metagraph-file', default='test/final.ckpt.meta',
                    help='name of the metagraph file')
parser.add_argument('--checkpoint-file', default='test/final.ckpt',
...
with tf.Session() as sess:
    ...
    reader = pywrap_tensorflow.NewCheckpointReader('/home/nyma/PycharmProjects/JointSSD/test/final.ckpt')
