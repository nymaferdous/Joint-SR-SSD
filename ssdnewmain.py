...
def train():
    ...
    # net = SSD(net_g512.outputs, preset, trainable)
    # losses['total'] = net.compute_loss(weight_decay=0.005)
    ...
    with tf.Session() as sess:
        ...
        # loader2 = tf.train.Saver(g_vars)
        # # saver2 = tf.train.Saver(g_vars, max_to_keep=10)
        # restore_vars = loader2.restore(sess, initial_weight_srgan)
        # #
        ...
        for epoch in range(0, n_epoch + 1):
            ...
            for idx in range(0, len(train_hr_img_list), batch_size):
                ...
                print("Generated Image", p[0].shape)
                net = SSDGRAPH(p[0],preset)
                ...
                _, errG, errM, errV, errA, errM_512, errV_512, errA_512 = sess.run(
                    ...
                    {t_image: b_imgs_96, t_target_image512: b_imgs_384,
                     t_target_image: b_imgs_256, net.image_input: p[0], net.labels: y
                    })
